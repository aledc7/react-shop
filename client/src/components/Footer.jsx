...
const Footer = () => {
  return (
    <Container>
      <Left>
        <Logo>Alejandro De Castro</Logo>
        <Description>Full Stack Systems Engineer</Description>
        <SocialContainer>
      ...
      <Right>
        <Title>Contact</Title>
        <ContactItem> <Room style={{ marginRight: "10px" }} />Rosario, Argentina - CP: (2000) </ContactItem>
        <ContactItem> <Phone style={{ marginRight: "10px" }} /> +54 3415555555</ContactItem>
